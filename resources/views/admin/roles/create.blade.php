<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Create Role</span>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        <x-card
            ...
            description="Define a role name and select the abilities assigned to this role."
        >
            <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-6">
                ...
                <div class="max-w-md">
                    <x-input
                        ...
                        required
                        autofocus
                        help="Unique name identifying this role."
                    />
                </div>
